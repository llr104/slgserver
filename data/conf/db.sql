...
CREATE TABLE IF NOT EXISTS `army` (
   ...
   `firstId` int unsigned NOT NULL DEFAULT 0 COMMENT '前锋武将',
   `secondId` int unsigned NOT NULL DEFAULT 0 COMMENT '中锋武将',
   `thirdId` int unsigned NOT NULL DEFAULT 0 COMMENT '大营武将',
