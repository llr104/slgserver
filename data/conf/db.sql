...
CREATE TABLE IF NOT EXISTS `war_report` (
   ...
   `beg_attack_general` varchar(2048) NOT NULL COMMENT '开始攻击方武将',
   `beg_defense_general` varchar(2048) NOT NULL COMMENT '开始防守方武将',
   `end_attack_general` varchar(2048) NOT NULL COMMENT '结束攻击方武将',
   `end_defense_general` varchar(2048) NOT NULL COMMENT '结束防守方武将',
