...
CREATE TABLE IF NOT EXISTS `general` (
   ...
   'rate'  int NOT NULL DEFAULT 0 COMMENT '稀有度(星级)',
   'arms' int NOT NULL DEFAULT 0 COMMENT '兵种',
   'arms_lv' int NOT NULL DEFAULT 1 COMMENT '兵种等级',
   'has_property_point' int NOT NULL DEFAULT 0 COMMENT '总属性点',
   'use_property_point' int NOT NULL DEFAULT 0 COMMENT '已用属性点',
   'step_lv' int NOT NULL DEFAULT 0 COMMENT '阶段',
...
CREATE TABLE IF NOT EXISTS `war_report` (
   ...
   `beg_attack_general` varchar(256) NOT NULL COMMENT '开始攻击方武将',
   `beg_defense_general` varchar(256) NOT NULL COMMENT '开始防守方武将',
   `end_attack_general` varchar(256) NOT NULL COMMENT '结束攻击方武将',
   `end_defense_general` varchar(256) NOT NULL COMMENT '结束防守方武将',
